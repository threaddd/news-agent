  ...
  return (
    <div className="flex flex-col items-center justify-center h-full relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/4 right-1/4 w-64 h-64 bg-gradient-to-br from-red-500/5 to-transparent rounded-full blur-3xl animate-bounce" style={{ animationDuration: '4s' }} />
      </div>
